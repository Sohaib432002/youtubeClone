...
const listbtnNames = [
  ...
  return (
    <>
      <Link>
      <div>
        <div className="w-[330px] mx-1 flex flex-col" >
          <div className="rounded-lg overflow-hidden">
              <img src={'https://materializecss.com/images/sample-1.jpg'} alt="" />
              </div>

          <div className="cardText flex justify-between p-2">
            <div>
              <p className="text-[16px]">Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum, at.</p>
